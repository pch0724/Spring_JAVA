...
@Controller
public class TestController_bak6 {
	/*
	 * @Autowired DataBean1 sessionBean1;
	 * 
	 * @Resource(name = "sessionBean2") DataBean2 sessionBean2;
	 * 
	 * @Autowired DataBean3 sessionBean3;
	 * 
	 * @Resource(name = "sessionBean4") DataBean4 sessionBean4;
	 * 
	 * @GetMapping("/test1") public String test1() { sessionBean1.setData1("data1");
	 * sessionBean1.setData2("data2");
	 * 
	 * sessionBean2.setData3("data3"); sessionBean2.setData4("data4");
	 * 
	 * sessionBean3.setData5("data5"); sessionBean3.setData6("data6");
	 * 
	 * sessionBean4.setData7("data7"); sessionBean4.setData8("data8");
	 * 
	 * return "test1"; }
	 * 
	 * @GetMapping("/result1") 
