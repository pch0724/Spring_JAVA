...
@Controller
public class TestController_bak12 {
	
	/*
	 * @GetMapping("/input_data") public String input_data() {
	 * 
	 * return "input_data"; }
	 * 
	 * //@Valid : 유효성 검사 //BindingResult : 유효성 검사 결과
	 * 
	 ...
	 * 
	 * if(result.hasErrors()) { for(ObjectError obj : result.getAllErrors()) {
	 ...
	 * System.out.println("---------------------------------------------");
	 * 
	 * String [] codes = obj.getCodes(); for(String c1 : codes) {
	 * System.out.println(c1); }
	 * 
	 * if(codes[0].equals("Size.dataBean.data1")) {
	 * System.out.println("data1은 2 ~ 10글자를 담을 수 있습니다"); } else
	 * if(codes[0].equals("Max.dataBean.data2")){
	 * System.out.println("data2는 100 이하의 값만 담을 수 있습니다"); }
	 * 
	 * return "input_data"; // 유효성검사 위배로로 인한 재입력 } }
	 * 
